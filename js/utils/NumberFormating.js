...
function exponentialFormat(num, precision, mantissa = true) {
    ...
    if (mantissa)
        return m.toStringWithDecimalPlaces(precision) + "×10"+ (e + '').sup()
    else return "10" + (e + '').sup()
}
...
function format(decimal, precision = 2, small) {
    ...
    if (decimal.gte("eeee1000")) {
        ...
        return "10" + '10'.sup()+"10".sup().sup()+"10".sup().sup().sup()+"10".sup().sup().sup().sup()+"10".sup().sup().sup().sup().sup()+ ("...").sup().sup().sup().sup().sup().sup() + ("["+format(slog)+' Layers]').sup().sup()
    }
...
function formatHeat(decimal) {
    ...
    if (decimal.gte(1e80)) return format(decimal.div(1e80), 2)+" Q"+"universe".sub()
    ...
    if (decimal.gte(1e15)) return format(decimal.div(1e15), 2)+" PJ"
    if (decimal.gte(1e12)) return format(decimal.div(1e12), 2)+" TJ"
    if (decimal.gte(1e9)) return format(decimal.div(1e9), 2)+" GJ"
    if (decimal.gte(1e6)) return format(decimal.div(1e6), 2)+" MJ"
